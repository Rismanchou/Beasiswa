        ...
        <div class="card-body">
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" id="nama_mahasiswa" value="<?= $mahasiswa->nama_mahasiswa ?>" name="nama_mahasiswa" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="jenis_kelamin">Jenis Kelamin</label>
                    <input type="text" id="jenis_kelamin" value="<?= $mahasiswa->jenis_kelamin ?>" name="jenis_kelamin"   class="form-control" required>
                </div>
                <form action="" method="post">
                <div class="form-group">
